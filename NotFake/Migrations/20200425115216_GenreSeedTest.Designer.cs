...
namespace NotFake.Migrations
{
    ...
    [Migration("20200425115216_GenreSeedTest")]
    partial class GenreSeedTest
    {
            ...
            modelBuilder.Entity("DAO.Models.Film", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { FilmId = 2, GenreId = 2, Name = "Action Film Example", ThumbnailAddress = "https://ia601204.us.archive.org/33/items/126BuddiesThickerThanWater1962/__ia_thumb.jpg", Type = 0 }
                    );
                });
            ...
            modelBuilder.Entity("DAO.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 1, Email = "admin@demo.com", Fullname = "admin", Password = "AATQQjNIRbSza1h39rHkypSrJHp4NWFeJO6ug8O0Jw5iJXeS7oZF446P+OkntjxlJA==", Role = 1 },
                        new { UserId = 2, Email = "user2@demo.com", Fullname = "user full name 2", Password = "AGIiemRo3htj1hy0IVKrZjkWhhXIH2IZs897BO4sbOuTz2tpcE/MzHjrQCUOSPtF6A==", Role = 0 },
                        new { UserId = 3, Email = "user3@demo.com", Fullname = "user full name 3", Password = "ACT41m9ka6mzN3Xq1BBMLgXfFixVBrRD5+lNTYcCJb3QigAToav9pEkBc+1Mx2Cmcw==", Role = 0 },
                        new { UserId = 4, Email = "user4@demo.com", Fullname = "user full name 4", Password = "AO7V1g197tSxZvGZeGC6r6lSqzlKa3t7Q1isRD5mR6SFSjH1FmYqS/SGkXmjycsBvQ==", Role = 0 },
                        new { UserId = 5, Email = "user5@demo.com", Fullname = "user full name 5", Password = "ACT+WZnzhe6iX1r/Wj1fV+IsDhRHxXvjb559dNIxvZbgxQxQ4op0iRYVXz+PZhCrng==", Role = 0 },
                        new { UserId = 6, Email = "user6@demo.com", Fullname = "user full name 6", Password = "ANN0y9SkllSPAjwEFHPF8drJM6QSDd5uuH7+2E07XRzRn7GkT7ewGakObd1nMZIqmw==", Role = 0 },
                        new { UserId = 7, Email = "user7@demo.com", Fullname = "user full name 7", Password = "ANVgXA62OtXyERwu8oOm4q5HkjWOxW6P154rGydhG3l+qzYTgEhZAeI61JxnA0GVuw==", Role = 0 },
                        new { UserId = 8, Email = "user8@demo.com", Fullname = "user full name 8", Password = "AFSN8uAsgcol4a3oWYeka2z7X9rYySndYkvDe27ECoBR+h/hWQdwXok8wAOfDyn9yg==", Role = 0 },
                        new { UserId = 9, Email = "user9@demo.com", Fullname = "user full name 9", Password = "AJpEVdpXCMBTR9v4r2h9aYvAt+hf/g6Nn6THGwiAmncjvsbq4Ruk3xF1zNo7RTnkrg==", Role = 0 }
                    );
                });
